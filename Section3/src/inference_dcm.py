...
def create_report(inference, header, orig_vol, pred_vol):
    ...
    # header_font = ImageFont.truetype("/home/workspace/src/assets/Roboto-Regular.ttf", size=40)
    # main_font = ImageFont.truetype("/home/workspace/src/assets/Roboto-Regular.ttf", size=20)
    ...
    draw.text((10, 50), "HippoVolume.AI", (255, 255, 255), font=header_font)
    draw.multiline_text((10, 150),
...
if __name__ == "__main__":
    ...
    pattern = 'HCropVolume'
    study_dir = list(filter(lambda x : pattern in x, subdirs))[0]
    ...
    inference_agent = UNetInferenceAgent(
        device="cpu",
        parameter_file_path=r"/home/workspace/trained_network/2022-09-21_1411_Basic_unet/model.pth")
